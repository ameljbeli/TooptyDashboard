...
namespace TooptyClient.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "IdCategorie,NomCategorie")] Categorie categorie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IdCategorie,NomCategorie")] Categorie categorie)
        {
            if (ModelState.IsValid)
            {
