...
namespace TooptyDashboard.Controllers
{
    public class CommandesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NumCommande,QteC,IdProduct,IdClient")] Commande commande)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NumCommande,QteC,IdProduct,IdClient")] Commande commande)
        {
            if (ModelState.IsValid)
            {
